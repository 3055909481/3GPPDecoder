...
class TSharkDecoder:public QObject
{
public:
    TSharkDecoder(QProcess* cmd);
    ~TSharkDecoder();
    void startDecoder(QString strEncodedData, QString strProtocol);

    void startDecoderWithWireshark(QString strProtocol);
protected:
...
private:
    ...
    void call_tsharkWithWireshark(QString strTsharkPath, QString strProtocol);
    void clean_output();
